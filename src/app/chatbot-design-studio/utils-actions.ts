...
export const ACTION_CATEGORY =[
    { type: getKeyByValue(TYPE_ACTION_CATEGORY.MOST_USED, TYPE_ACTION_CATEGORY),    name: 'CDSActionCategory.MostUsed',     src: 'td-star'},
    { type: getKeyByValue(TYPE_ACTION_CATEGORY.AI, TYPE_ACTION_CATEGORY),           name: 'CDSActionCategory.AI',           src: 'td-brain'},
    { type: getKeyByValue(TYPE_ACTION_CATEGORY.FLOW, TYPE_ACTION_CATEGORY),         name: 'CDSActionCategory.Flow',         src: 'td-git-branch'},
    { type: getKeyByValue(TYPE_ACTION_CATEGORY.INTEGRATIONS, TYPE_ACTION_CATEGORY), name: 'CDSActionCategory.Integrations', src: 'td-grid-dots'},
    { type: getKeyByValue(TYPE_ACTION_CATEGORY.SPECIAL, TYPE_ACTION_CATEGORY),      name: 'CDSActionCategory.Special',      src: 'td-award'},
...
export const ACTIONS_LIST: {
    ...
    WHATSAPP_STATIC:        { name: 'CDSActionList.NAME.WhatsAppStatic',        chatbot_types: [TYPE_CHATBOT.CHATBOT, TYPE_CHATBOT.WEBHOOK, TYPE_CHATBOT.COPILOT],                                                   category: TYPE_ACTION_CATEGORY.INTEGRATIONS,        type: TYPE_ACTION.WHATSAPP_STATIC,      src: "assets/images/actions/whatsapp.svg",              status: "active",                       doc: "CDSActionList.DOC.WhatsAppStatic",          channelBadge: "WABA", channelWarning: "CDSActionList.CHANNEL_WARNING.WabaSpecific" },
    WHATSAPP_ATTRIBUTE:     { name: 'CDSActionList.NAME.WhatsAppByAttribute',   chatbot_types: [TYPE_CHATBOT.CHATBOT, TYPE_CHATBOT.WEBHOOK, TYPE_CHATBOT.COPILOT],                                                   category: TYPE_ACTION_CATEGORY.INTEGRATIONS,        type: TYPE_ACTION.WHATSAPP_ATTRIBUTE,   src: "assets/images/actions/whatsapp.svg",              status: "active",                       doc: "CDSActionList.DOC.WhatsAppByAttribute",     channelBadge: "WABA", channelWarning: "CDSActionList.CHANNEL_WARNING.WabaSpecific" },
    SEND_WHATSAPP:          { name: 'CDSActionList.NAME.SendWhatsapp',          chatbot_types: [TYPE_CHATBOT.CHATBOT, TYPE_CHATBOT.WEBHOOK, TYPE_CHATBOT.COPILOT],                                                   category: TYPE_ACTION_CATEGORY.INTEGRATIONS,        type: TYPE_ACTION.SEND_WHATSAPP,        src: "assets/images/actions/whatsapp.svg",              status: "active",                       doc: "CDSActionList.DOC.SendWhatsapp",            channelBadge: "WABA", channelWarning: "CDSActionList.CHANNEL_WARNING.WabaSpecific" },
    ...
    AI_CONDITION:           { name: 'CDSActionList.NAME.AiCondition',           chatbot_types: [TYPE_CHATBOT.CHATBOT, TYPE_CHATBOT.WEBHOOK, TYPE_CHATBOT.COPILOT, TYPE_CHATBOT.VOICE, TYPE_CHATBOT.VOICE_TWILIO],    category: TYPE_ACTION_CATEGORY.AI,                  type: TYPE_ACTION.AI_CONDITION,         src: "assets/images/actions/ai-condition.svg",          status: "active", plan: PLAN_NAME.E, badge: 'BETA',       doc: "CDSActionList.DOC.AiCondition",                     },
    ...
    FLOW_LOG:               { name: 'CDSActionList.NAME.FlowLog',               chatbot_types: [TYPE_CHATBOT.CHATBOT, TYPE_CHATBOT.WEBHOOK, TYPE_CHATBOT.COPILOT],                                                   category: TYPE_ACTION_CATEGORY.SPECIAL,             type: TYPE_ACTION.FLOW_LOG,             src: "assets/images/actions/flow_log.svg",                   status: "active",                       badge: '',     doc: "",                                       },

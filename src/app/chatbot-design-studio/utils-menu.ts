...
export const SUPPORT_OPTIONS: { [key: string]: Array<{ key: string, label: string, icon: string, type: TYPE_URL, src?: string, description?: string}>} = {
    ...
    "CONTACT_US": [
        { key: 'EMAIL',   label: 'SendUsEmail',    icon: 'mail',   type: TYPE_URL.BLANK ,  src: 'mailto:redacted@example.invalid', description:"redacted@example.invalid"},
        { key: 'CHAT',   label: 'ChatUs',    icon: 'forum',   type: TYPE_URL.BLANK ,  src: 'mailto:redacted@example.invalid', description:"redacted@example.invalid"},

...
export var INFO_MENU_ITEMS: Array<{ key: string, label: string, icon: string, type: TYPE_URL, status:"active" | "inactive", src?: string}> = [
    ...
    { key: 'SUPPORT', label: 'redacted@example.invalid', icon: 'email', type: TYPE_URL.SELF, status: "active", src: 'mailto:redacted@example.invalid'},
    { key: 'CHANGELOG',  label: 'Changelog', icon: 'local_fire_department', type: TYPE_URL.BLANK, status: "active", src:'https://feedback.tiledesk.com/changelog'},

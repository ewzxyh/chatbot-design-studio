...
export const INFO_MENU_ITEMS: Array<{ key: string, label: string, icon: string, type: TYPE_URL, src?: string}> = [
    ...
    { key: 'SUPPORT', label: 'redacted@example.invalid', icon: 'email', type: TYPE_URL.SELF, src: 'mailto:redacted@example.invalid'},
    ...
    { key: 'DISCORD', label: 'Discord', icon: 'assets/images/discord.svg', type: TYPE_URL.BLANK, src: 'https://discord.gg/mcuCmKKn'}
]
